...
router.get("/status", function (req, res) {
   ...
   try {
       ...
       Customer.find({ email: decoded.email }, "email lastAccess measurementFrequency startHour startMinute endHour endMinute devices BPMData OXData", function (err, users) {
           if (err) {
